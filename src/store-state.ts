...
export type ResolutionTargetKey = { modlistName: string; mcVersion: string; modLoader: string };
export const [resolvedTarget, setResolvedTarget] = createSignal<ResolutionTargetKey | null>(null);
